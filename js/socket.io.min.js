!function(t, e) {
    ...
    return r = [function(t, e, n) {
        function r(t, e) {
            ...
            var t = i(t)
              ...
              , o = t.path
              , o = c[r] && o in c[r].nsps
              , o = e.forceNew || e["force new connection"] || !1 === e.multiplex || o ? (a("ignoring socket cache for %s", n),
            s(n, e)) : (c[r] || (a("new io instance for %s", n),
            c[r] = s(n, e)),
            c[r]);
            return t.query && !e.query && (e.query = t.query),
            o.socket(t.path, e)
        }
        var i = n(1)
          , o = n(7)
    ...
    , function(t, e, n) {
        ...
        t.exports = function(t, e) {
            var n = t;
            return e = e || "undefined" != typeof location && location,
    ...
    , function(t, e) {
        var c = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/
          , p = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"];
    ...
    , function(r, o, i) {
        !function(e) {
            ...
            o.formatArgs = function(t) {
                var e, n, r = this.useColors;
                t[0] = (r ? "%c" : "") + this.namespace + (r ? " %c" : " ") + t[0] + (r ? "%c " : " ") + "+" + o.humanize(this.diff),
                r && (r = "color: " + this.color,
                ...
                if (s.enabled) {
                    ...
                    o[0] = o[0].replace(/%([a-zA-Z%])/g, function(t, e) {
                        if ("%%" === t)
                            return t;
                        i++;
                        var n, e = c.formatters[e];
                        return "function" == typeof e && (n = o[i],
                        t = e.call(r, n),
                        o.splice(i, 1),
                        i--),
                        t
        ...
        t.exports = function(t, e) {
            ...
            if (!("string" == n && 0 < t.length)) {
                if ("number" == n && !1 === isNaN(t))
                    return e.long ? o(n = t, s, "day") || o(n, i, "hour") || o(n, 6e4, "minute") || o(n, 1e3, "second") || n + " ms" : s <= (e = t) ? Math.round(e / s) + "d" : i <= e ? Math.round(e / i) + "h" : 6e4 <= e ? Math.round(e / 6e4) + "m" : 1e3 <= e ? Math.round(e / 1e3) + "s" : e + "ms";
                throw new Error("val is not a non-empty string or a valid number. val=" + JSON.stringify(t))
            }
            n = t;
            if (!(100 < (n = String(n)).length)) {
                n = /^((?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|years?|yrs?|y)?$/i.exec(n);
                if (n) {
    ...
    , function(t, s, e) {
        ...
        function r(t) {
            var e = "" + t.type;
            if (s.BINARY_EVENT !== t.type && s.BINARY_ACK !== t.type || (e += t.attachments + "-"),
            t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
            null != t.id && (e += t.id),
            null != t.data) {
                var n = function(t) {
        ...
        var h = e(3)("socket.io-parser")
          ...
          , d = e(11)
          , y = (s.protocol = 4,
        s.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"],
        s.CONNECT = 0,
        s.DISCONNECT = 1,
        s.EVENT = 2,
        s.ACK = 3,
        ...
        n.prototype.encode = function(t, e) {
            ...
            s.BINARY_EVENT === t.type || s.BINARY_ACK === t.type ? o(t, e) : e([r(t)])
        }
        ,
        u(i.prototype),
        i.prototype.add = function(t) {
            ...
            if ("string" == typeof t)
                e = a(t),
                s.BINARY_EVENT === e.type || s.BINARY_ACK === e.type ? (this.reconstructor = new c(e),
        ...
        c.prototype.takeBinaryData = function(t) {
            ...
            this.buffers.length === this.reconPack.attachments ? (t = f.reconstructPacket(this.reconPack, this.buffers),
    ...
    , function(t, e, n) {
        var h = n(10)
          ...
          , f = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === n.call(Blob)
          , l = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === n.call(File);
    ...
    , function(t, e, n) {
        ...
        r.prototype.open = r.prototype.connect = function(n, t) {
            ...
            var e, r, o = this.engine, i = this, s = (this.readyState = "opening",
            ...
            p(o, "open", function() {
                ...
                n(e)) : i.maybeReconnectOnOpen()
            });
            return !1 !== this._timeout && (e = this._timeout,
        ...
        u.prototype.probe = function(n) {
            function t() {
                ...
                c.once("packet", function(t) {
                    p || ("pong" === t.type && "probe" === t.data ? (f('probe transport "%s" pong', n),
                    h.upgrading = !0,
                    h.emit("upgrading", c),
                    c && (u.priorWebsocketSuccess = "websocket" === c.name,
    ...
    , function(t, e, n) {
        ...
        i.requestsCount = 0,
        i.requests = {},
        "undefined" != typeof document && ("function" == typeof attachEvent ? attachEvent("onunload", s) : "function" == typeof addEventListener && (t = "onpagehide"in n ? "pagehide" : "unload",
    ...
    , function(t, e, n) {
        ...
        r.prototype.onData = function(t) {
            ...
            s.decodePayload(t, this.socket.binaryType, function(t, e, n) {
                return "opening" === r.readyState && "open" === t.type && r.onOpen(),
    ...
    , function(t, f, e) {
                ...
                return f.encodeBase64Packet(t, n);
            {
                if (p) {
                    var r = t
                      ...
                      , i = n;
                    if (!o)
                        return f.encodeBase64Packet(r, i);
                ...
                return (e = new Uint8Array(1))[0] = y[t.type],
                n(new m([e.buffer, t.data]))
            }
        }
        function i(t, e, n) {
            for (var o = new Array(t.length), r = a(t.length, n), i = 0; i < t.length; i++)
                !function(n, t, r) {
                    e(t, function(t, e) {
                        o[n] = e,
                        r(t, o)
        ...
        var r, n = e(23), s = e(24), l = e(25), a = e(26), d = e(27), o = ("undefined" != typeof ArrayBuffer && (r = e(28)),
        "undefined" != typeof navigator && /Android/i.test(navigator.userAgent)), c = "undefined" != typeof navigator && /PhantomJS/i.test(navigator.userAgent), p = o || c, y = (f.protocol = 3,
        f.packets = {
            open: 0,
            close: 1,
            ping: 2,
        ...
        f.encodePacket = function(t, e, n, r) {
            ...
            if ("undefined" != typeof ArrayBuffer && o instanceof ArrayBuffer) {
                var i = t
                  , s = r;
                if (!(a = e))
                    return f.encodeBase64Packet(i, s);
                var a = i.data
                  , c = new Uint8Array(a)
            ...
            if (void 0 !== m && o instanceof m)
                return u(t, e, r);
            if (o && o.base64)
                return r("b" + f.packets[t.type] + t.data.data);
            a = y[t.type];
            return void 0 !== t.data && (a += n ? d.encode(String(t.data), {
                strict: !1
            }) : String(t.data)),
            r("" + a)
        }
        ...
        f.encodeBase64Packet = function(e, n) {
            var r, o, i = "b" + f.packets[e.type];
            if (void 0 !== m && e.data instanceof m)
                return (r = new FileReader).onload = function() {
        ...
        f.decodePacket = function(t, e, n) {
            ...
            if ("string" == typeof t) {
                ...
                if (n && !1 === (t = function(t) {
                    ...
                    return g;
                var r = t.charAt(0);
                return Number(r) == r && h[r] ? 1 < t.length ? {
                    type: h[r],
                    data: t.substring(1)
                } : {
                    type: h[r]
        ...
        f.encodePayload = function(t, n, r) {
            ...
            n = null);
            var o = s(t);
            return n && o ? m && !p ? f.encodePayloadAsBlob(t, r) : f.encodePayloadAsArrayBuffer(t, r) : t.length ? void i(t, function(t, e) {
        ...
        f.decodePayload = function(t, e, n) {
            ...
            for (var r, o, i = "", s = 0, a = t.length; s < a; s++) {
                ...
                if (":" === c) {
                    if ("" === i || i != (r = Number(i)))
                        return n(g, 0, 1);
                    if (i != (o = t.substr(s + 1, r)).length)
                        return n(g, 0, 1);
                    if (o.length) {
                        if (o = f.decodePacket(o, e, !1),
        ...
        f.encodePayloadAsArrayBuffer = function(t, r) {
            return t.length ? void i(t, function(t, e) {
        ...
        f.encodePayloadAsBlob = function(t, n) {
            i(t, function(t, s) {
                f.encodePacket(t, !0, !0, function(t) {
                    ...
                    for (var o = (t instanceof ArrayBuffer ? t.byteLength : t.size).toString(), i = new Uint8Array(o.length + 1), r = 0; r < o.length; r++)
                        i[r] = parseInt(o[r]);
                    i[o.length] = 255,
                    m && (e = new m([e.buffer, i.buffer, t]),
                    s(null, e))
                })
            }, function(t, e) {
                return n(new m(e))
            ...
            for (var e = t, o = []; 0 < e.byteLength; ) {
                ...
                if (s)
                    try {
                        ...
                        for (var h = new Uint8Array(p), p = "", c = 0; c < h.length; c++)
    ...
    , function(t, e) {
        t.exports = Object.keys || function(t) {
            var e, n = [], r = Object.prototype.hasOwnProperty;
            for (e in t)
                r.call(t, e) && n.push(e);
            return n
        }
    ...
    , function(t, e) {
        ...
        t.exports = {
            version: "2.1.2",
            encode: function(t, e) {
                for (var n = !1 !== (e = e || {}).strict, r = h(t), o = r.length, i = -1, s = ""; ++i < o; )
                    s += function(t, e) {
                        if (0 == (4294967168 & t))
                            return g(t);
                        var n = "";
                        return 0 == (4294965248 & t) ? n = g(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (u(t, e) || (t = 65533),
                        n = g(t >> 12 & 15 | 224),
                        n += a(t, 6)) : 0 == (4292870144 & t) && (n = g(t >> 18 & 7 | 240),
                        n = (n += a(t, 12)) + a(t, 6)),
                        n + g(63 & t | 128)
                    }(r[i], n);
                return s
            ...
            decode: function(t, e) {
                ...
                for (var r, o = []; !1 !== (r = function(t) {
                    ...
                    if (240 == (248 & e) && (65536 <= (n = (7 & e) << 18 | f() << 12 | f() << 6 | f()) && n <= 1114111))
                        return n;
                    throw Error("Invalid UTF-8 detected")
                }(n)); )
                    o.push(r);
                for (var i, s = o, a = s.length, c = -1, p = ""; ++c < a; )
                    65535 < (i = s[c]) && (p += g((i -= 65536) >>> 10 & 1023 | 55296),
                    i = 56320 | 1023 & i),
                    p += g(i);
                return p
            }
        ...
        !function(h) {
            ...
            e.encode = function(t) {
                for (var e = new Uint8Array(t), n = e.length, r = "", o = 0; o < n; o += 3)
                    r = (r = (r = (r += h[e[o] >> 2]) + h[(3 & e[o]) << 4 | e[o + 1] >> 4]) + h[(15 & e[o + 1]) << 2 | e[o + 2] >> 6]) + h[63 & e[o + 2]];
                return n % 3 == 2 ? r = r.substring(0, r.length - 1) + "=" : n % 3 == 1 && (r = r.substring(0, r.length - 2) + "=="),
                r
            }
            ,
            e.decode = function(t) {
                for (var e, n, r, o, i = .75 * t.length, s = t.length, a = 0, i = ("=" === t[t.length - 1] && (i--,
                "=" === t[t.length - 2] && i--),
                new ArrayBuffer(i)), c = new Uint8Array(i), p = 0; p < s; p += 4)
                    e = h.indexOf(t[p]),
                    n = h.indexOf(t[p + 1]),
                    r = h.indexOf(t[p + 2]),
                    o = h.indexOf(t[p + 3]),
    ...
    , function(t, e) {
        function r(t) {
            return t.map(function(t) {
                var e, n;
                return t.buffer instanceof ArrayBuffer ? (e = t.buffer,
                t.byteLength !== e.byteLength && ((n = new Uint8Array(t.byteLength)).set(new Uint8Array(e,t.byteOffset,t.byteLength)),
                e = n.buffer),
                e) : t
            })
        }
    ...
    , function(t, e, n) {
        ...
        o.prototype.doPoll = function() {
            var e = this
              ...
              , n = (this.script && (this.script.parentNode.removeChild(this.script),
            this.script = null),
            t.async = !0,
            t.src = this.uri(),
